(() => {
  ...
  const english = {
    ...
    'Daripada situ, barulah kami tahu bahawa Abdul sudah tidak sihat untuk suatu tempoh. Tidak lama kemudian, Abdul pula tidak dapat ditemui. Pelajar diminta memaklumkan kepada komuniti jika ternampak Abdul supaya bantuan dan rawatan veterinar boleh diatur.': 'Only then did we learn that Abdul had been unwell for some time. Soon afterward, he could not be found. Students were asked to let the community know if they saw him so help and veterinary care could be arranged.',
    'Abdul akhirnya ditemui sedang bersembunyi di bawah longkang dalam keadaan tidak sihat. Pengalaman itu membuka mata kami kepada satu masalah yang sangat mudah: pelajar mungkin orang pertama yang nampak sesuatu, tetapi orang lain mungkin mempunyai pengangkutan, carrier, bekalan atau kenalan veterinar untuk membantu.': 'Abdul was eventually found hiding beneath a drain, unwell. That experience brought a simple problem into focus: students may be the first to notice something, while someone else may have transport, a carrier, supplies or a veterinary contact to help.',
    ...
    'Daripada pengalaman itulah Pencinta Kucing KVKS diwujudkan—bukan untuk mencari salah, tetapi untuk menghubungkan pemerhatian dengan bantuan.': 'Pencinta Kucing KVKS grew from that experience—to connect what people notice with people who can help, without assigning blame.',
